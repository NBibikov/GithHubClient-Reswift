...
SWIFT_MODULE_NAMESPACE_PUSH("OctoKit")
@class User;
@class Label;
@class Milestone;
...
SWIFT_CLASS("_TtC7OctoKit11PullRequest")
@interface PullRequest : NSObject
@property (nonatomic) NSInteger id;
@property (nonatomic, copy) NSURL * _Nullable url;
@property (nonatomic, copy) NSURL * _Nullable htmlURL;
@property (nonatomic, copy) NSURL * _Nullable diffURL;
@property (nonatomic, copy) NSURL * _Nullable patchURL;
@property (nonatomic, copy) NSURL * _Nullable issueURL;
@property (nonatomic, copy) NSURL * _Nullable commitsURL;
@property (nonatomic, copy) NSURL * _Nullable reviewCommentsURL;
@property (nonatomic, copy) NSURL * _Nullable reviewCommentURL;
@property (nonatomic, copy) NSURL * _Nullable commentsURL;
@property (nonatomic, copy) NSURL * _Nullable statusesURL;
@property (nonatomic, copy) NSString * _Nullable title;
@property (nonatomic, copy) NSString * _Nullable body;
@property (nonatomic, strong) User * _Nullable assignee;
@property (nonatomic, strong) Milestone * _Nullable milestone;
...
@property (nonatomic, copy) NSDate * _Nullable updatedAt;
@property (nonatomic, copy) NSDate * _Nullable closedAt;
@property (nonatomic, copy) NSDate * _Nullable mergedAt;
@property (nonatomic, strong) User * _Nullable user;
- (nonnull instancetype)init:(NSDictionary<NSString *, id> * _Nonnull)json OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
